function CGame(oData){
                ...
                if(_bDealerLoseInCurHand){
                    ...
                    do{
                        ...
                        if(iValue === 11 && (_iDealerValueCard + iValue) > 21){
                            ...
                            ((_iDealerValueCard + iValue) > 16 && (_iDealerValueCard + iValue) < _oSeat.getHandValue(0) && _oSeat.getHandValue(0) < 21));
                }
    ...
    this._dealing = function(){
        if(_iCardIndexToDeal<_aCurActiveCardOffset.length*2){
                ...
                if((_iCardIndexToDeal%_aCurActiveCardOffset.length) === 1){
                    ...
                    var iFirstValue = s_oGameSettings.getCardValue(_aCardsInCurHandForPlayer[_iNextCardForPlayer-1]);
                        
                        do{
                            _aCardsInCurHandForPlayer.shift();
                        }while((iFirstValue + s_oGameSettings.getCardValue(_aCardsInCurHandForPlayer[_iNextCardForPlayer]) ) === 21);
    ...
    this._checkAvailableActionForPlayer = function(){	
            ...
            if(iPlayerValueCard === 21){
                    ...
                    if(_aDealerCards[0].getValue() === 11 && _oSeat.getCredit() >= (_oSeat.getCurBet()/2) ){
    ...
    this.onDeal = function(){
        if(_oSeat.getCredit()+_oSeat.getCurBet()<_iMinBet){
            this._gameOver();
