function CFichesController(pPos,pInsurance){
    ...
    this._init= function(pPos,pInsurance){
        _oFichesAttach = new createjs.Container();
        _oFichesAttach.x = pPos.x;
        _oFichesAttach.y = pPos.y;
    ...
    this.refreshFiches = function(aFiches,iXPos,iYPos,bInsurance){
        ...
        for(var i=0;i<aFiches.length;i++){
                ...
                _iValue = parseFloat(_iValue.toFixed(2));
        }
    ...
    this.createFichesPile = function(iAmount,bInsurance){
        ...
        do{
            ...
            iRestAmount = parseFloat(iRestAmount.toFixed(2));
